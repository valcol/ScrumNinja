...
import IndividualFile from './Upload.jsx';
import {_} from 'meteor/underscore';

@ReactMeteorData //replace mixins
export class Specifications extends Component {

  constructor(props) {
    super(props);
    this.state = {uploading: [], progress: 0, inProgress: false};
  ...
  getMeteorData() {
    let handle = Meteor.subscribe('files.CDC.all');
    return {
